/**
 * @author Mansiz <mansiztripathi@gmail.com>
 */
(function ($) {
    "use strict";
...
var x = setInterval(function() {
    ...
    "<div class='hours block'>" + hours + "<br>Hours</div>" + "<div class='minutes block'>" + minutes + "<br>Minutes</div>" +
...
console.log('\n\n%c SAVE THE DATE: 07th Dec, 2021!', styles);

console.log('%cYour presence is requested!%c\n\nRegards: Mansiz Tripathi', styles1, styles2);
